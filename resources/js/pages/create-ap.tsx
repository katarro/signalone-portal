...
export default function CreateAp({ vlans, zonas }: CreateApProps) {
  const { data, setData, post, processing, errors } = useForm<CreateApForm>({
    name: "",
    ssid: "",
    ip_address: "",
    mac_address: "",
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2">
          <div className="flex items-center gap-2 px-4">
            ...
            <h1 className="text-lg font-semibold">Crear Access Point</h1>
          </div>
        </header>
          ...
          <div className="max-w-4xl mx-auto w-full">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Crear Access Point</CardTitle>
                <CardDescription>
                  Configure un nuevo Access Point para la red inalámbrica
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={submit} className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Select onValueChange={(value) => setData('zona_id', value)}>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select onValueChange={(value) => setData('vlan_id', value)}>
                  ...
                  <div className="flex justify-end gap-4">
                    ...
                    <Button type="submit" disabled={processing}>
                      {processing ? "Creando..." : "Crear Access Point"}
                    </Button>
                  </div>
                </form>
              </CardContent>
